...
(function($){
    $.fn.validate = function(){
                ...
                inputObj.blur(function(){
                    ...
                    for(var i = 0 ; i < validates.length ; i++){
                        ...
                        if(func(inputObj,validate)){
                                 tip(inputObj,'<p class="tg">校验通过</p>','blue');
                        }else{
        ...
        function tip(obj,msg,color){
            ...
            if(tips.length==0){
                obj.parent().append("<span class='submit-tips'><font color="+color+">"+msg+"</font></span>");
            }
            else{
                tips.html("<span class='submit-tips'><font color="+color+">"+msg+"</font></span>");
                tongguo();
                }
    ...
    function tongguo(){
      if(($(".phone").find(".tg").length>0)&&($(".name").find(".tg").length>0)&&($(".email").find(".tg").length>0)){
        $('#wybm').attr('href', 'tijiao.html').css('background', '#f6254c');
      };
    };
